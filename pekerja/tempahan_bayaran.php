...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO tempahan (no_mykad_pelanggan, kod_produk, tarikh_tempah, kuantiti, jumlah_harga, cara_bayaran, catatan) VALUES (%s, %s, %s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "senarai_tempahan.php";
  if (isset($_SERVER['QUERY_STRING'])) {
                              ...
                              <tr valign="baseline">
                                <td><table align="center" cellpadding="5" cellspacing="5">
                                  <tr valign="baseline">
                                    ...
                                    <td><input name="no_mykad_pelanggan" type="text" value="" size="44" maxlength="12"></td>
                                  </tr>
                                  <tr valign="baseline">
