                            ...
                            <table border="1" align="center" id="address">
                              ...
                              <?php do { ?>
                                <tr>
                                  ...
                                  <td bgcolor="#FFFFFF" align="center"><a href="../admin/butiranpelanggan.php?no_mykad_pelanggan=<?php echo $row_rsTempahan['no_mykad_pelanggan']; ?>"><?php echo $row_rsTempahan['no_mykad_pelanggan']; ?></a></td>
                                  <td bgcolor="#FFFFFF" align="center"><a href="../admin/butiranproduk.php?kod_produk=<?php echo $row_rsTempahan['kod_produk']; ?>"></a><a href="../admin/butiranproduk.php?kod_produk=<?php echo $row_rsTempahan['kod_produk']; ?>"><?php echo $row_rsTempahan['kod_produk']; ?></a></td>
                                  ...
                                  <td bgcolor="#FFFFFF" align="center"><a href="kemaskinitempahan.php?no_tempahan=<?php echo $row_rsTempahan['no_tempahan']; ?>"><img src="../admin/images/Edit.png" width="29" height="29"></a></td>
                                  <td bgcolor="#FFFFFF" align="center"><a href="../admin/padamtempahan.php?no_tempahan=<?php echo $row_rsTempahan['no_tempahan']; ?>" onClick="return confirm('Anda pasti untuk padam?')"><img src="../admin/images/Bin.png" width="30" height="29"></a></td>
                                </tr>
...
<br/>
                           ...
                           <center>
                             <table width="157" border="1" cellspacing="1" cellpadding="1" align="center">
                               <tr>
                                 <td width="71"><a href="../admin/tambahtempahan.php"><img src="../admin/images/Button Add.png" alt="tambah" width="81" height="80"></a></td>
                                 <td width="116"><a href="../admin/cetak.php" target="_blank"><img src="../admin/images/Printer.png" width="81" height="80" alt="cetak"></a></td>
                               </tr>
                             </table>
                           </center></p>
                          <p>&nbsp;</p>
