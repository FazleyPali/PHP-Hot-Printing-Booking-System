                                  ...
                                  <tr>
                                    <td><a href="butiranproduk.php?kod_produk=<?php echo $row_rsProduk['kod_produk']; ?>"><img src="../_produk/<?php echo $row_rsProduk['gambar']; ?>" width="200" height="200" alt="<?php echo $row_rsProduk['nama_produk']; ?>"></a>
                                      <center>
                                        ...
                                        RM <?php echo $row_rsProduk['harga']; ?>
                                    </center></td>
                                  </tr>
                                </table></td>
                              <?php  $rsProduk_endRow++;
...
echo("</tr>");
                          ...
                          <a href="<?php printf("%s?pageNum_rsProduk=%d%s", $currentPage, max(0, $pageNum_rsProduk - 1), $queryString_rsProduk); ?>">
                          <?php if ($pageNum_rsProduk >= $totalPages_rsProduk) { // Show if last page ?>
                            <img src="../Icon for Web Design/Reflection Icons/Reflection Icons/Reflection Icons png files/Arrow Right 1.png" width="50" height="50">
                            <?php } // Show if last page ?>
                          </a><a href="<?php printf("%s?pageNum_rsProduk=%d%s", $currentPage, min($totalPages_rsProduk, $pageNum_rsProduk + 1), $queryString_rsProduk); ?>"></a>
                          <?php if ($pageNum_rsProduk == 0) { // Show if first page ?>
                            <a href="<?php printf("%s?pageNum_rsProduk=%d%s", $currentPage, min($totalPages_rsProduk, $pageNum_rsProduk + 1), $queryString_rsProduk); ?>"><img src="../Icon for Web Design/Reflection Icons/Reflection Icons/Reflection Icons png files/Arrow Left 1.png" width="50" height="50"></a>
