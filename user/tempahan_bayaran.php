...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertGoTo = "semak_tempahan.php?no_mykad_pelanggan=" . $row_rsTempahan['no_mykad_pelanggan'] . "";
  if (isset($_SERVER['QUERY_STRING'])) {
          ...
          <div class="wrapper">
            <nav>
              ...
              <ul id="menu">
                ...
                <li id="nav2"><a href="produk.php" class="active">senarai<span>produk</span></a></li>
...
document.getElementById('datetext').value = year + '-' + month + '-' + day;
                              ...
                              <center>
                                <img src="../_produk/<?php echo $row_rsProduk['gambar']; ?>" width="297" height="300">
                              </center>
                            </p>
                              ...
                              <tr valign="baseline">
                                <td><table align="center" cellpadding="5" cellspacing="5">
                                  <tr valign="baseline">
                                    ...
                                    <td><input name="no_mykad_pelanggan" type="text" id="no_mykad_pelanggan" value=" <?php echo $_SESSION['no_mykad_pelanggan']; ?>" size="44" readonly>
                                     </td>
                                  </tr>
                                  <tr valign="baseline">
                                    <td nowrap align="right">Kod Produk:</td>
                                    <td><input name="kod_produk" type="text" value="<?php echo $row_rsProduk['kod_produk']; ?>" size="44" maxlength="100" readonly></td>
                                  </tr>
                                  <tr valign="baseline">
                                    <td nowrap align="right">Harga (RM):</td>
                                    <td><input name="harga" type="text" id="harga" value="<?php echo $row_rsProduk['harga']; ?>" size="44" readonly></td>
                                  </tr>
                                  <tr valign="baseline">
                                    <td nowrap align="right">Tarikh Tempah:</td>
                                    <td><input name="tarikh_tempah" type="text" id="datetext" size="44" readonly></td>
                                  </tr>
                                  <tr valign="baseline">
                                  ...
                                  <tr valign="baseline">
                                    ...
                                    <td><input type="submit" value="Tempah" onClick="return confirm('Anda pasti untuk tempah?')"></td>
                                  </tr>
                                </table></td>
                              </tr>
                            </table>
