...
mysql_select_db($database_SistemTempahan, $SistemTempahan);
$query_rsTempahan = "SELECT no_tempahan, no_mykad_pelanggan, kod_produk, tarikh_tempah, kuantiti, jumlah_harga, cara_bayaran, status, catatan, lakaran FROM tempahan WHERE no_tempahan = no_tempahan";
                         ...
                         <center>
                          <table border="0" align="center" cellpadding="5" cellspacing="5">
                              ...
                              <tr valign="baseline">
                                ...
                                <td><img src="lakaran/<?php echo $row_rsTempahan['lakaran']; ?>" width="250" height="250"></td>
                              </tr>
                              <tr valign="baseline">
                              ...
                              <tr valign="baseline">
                                ...
                                <td><p>&nbsp;</p>
                               <a href="semak_tempahan.php"><img src="../images/check-icon.png" alt="" width="43" height="32" id="sprytrigger1"></a><a href="padamtempahan.php?no_tempahan=<?php echo $row_rsTempahan['no_tempahan']; ?>" onClick="return confirm('Anda pasti untuk batal?')"><img src="../images/button_cancel.png" alt="" width="32" height="32" id="sprytrigger2"></a></td>
                              </tr>
                            </table>
                            </center>
...
<div class="tooltipContent" id="sprytooltip2">Batal</div>
<div class="tooltipContent" id="sprytooltip1">Sahkan Tempahan</div>
<div class="main">
  <!-- footer -->
