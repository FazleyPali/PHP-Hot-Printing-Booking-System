...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertGoTo = "tempahan_berjaya.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_SistemTempahan, $SistemTempahan);
$query_rsTempahan = "SELECT no_mykad_pelanggan, kod_produk, tarikh_tempah, kuantiti, jumlah_harga, cara_bayaran, catatan, lakaran FROM tempahan";
                              ...
                              <tr valign="baseline">
                                <td><table align="center" cellpadding="5" cellspacing="5">
                                  <tr valign="baseline">
                                    ...
                                    <td><input name="no_mykad_pelanggan" type="text" value="<?php echo $_SESSION['no_mykad_pelanggan']; ?>" size="44" maxlength="12"></td>
                                  </tr>
                                  <tr valign="baseline">
                                    <td nowrap align="right">Kod Produk:</td>
                                    <td><input name="kod_produk" type="text" value="<?php echo $row_rsProduk['kod_produk']; ?>" size="44"></td>
                                  </tr>
                                  <tr valign="baseline">
                                    <td nowrap align="right">Harga (RM):</td>
                                    <td><input type="text" name="jumlah_harga" value="<?php echo $row_rsProduk['harga']; ?>" size="44"></td>
                                  </tr>
                                  <tr valign="baseline">
