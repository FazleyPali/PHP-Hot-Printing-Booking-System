...
$colname_rsPekerja = "-1";
if (isset($_GET['ic'])) {
  $colname_rsPekerja = $_GET['ic'];
}
mysql_select_db($database_SistemTempahan, $SistemTempahan);
$query_rsPekerja = sprintf("SELECT * FROM pekerja WHERE no_mykad_pekerja LIKE %s", GetSQLValueString("%" . $colname_rsPekerja . "%", "text"));
          ...
          <div class="wrapper">
            <nav>
              ...
              <ul id="menu">
                ...
                <li id="nav7"><a href="../logout.php">log<span>keluar</span></a></li>
              </ul>
            </nav>
          </div>
        </header>
                           ...
                           <center>
                             <table width="157" border="1" cellspacing="1" cellpadding="1" align="center">
                               <tr>
                                 ...
                                 <td width="116"><a href="cetak.php" target="_blank"><img src="images/Printer.png" alt="cetak" width="81" height="80" id="sprytrigger4"></a></td>
                               </tr>
                             </table>
                           </center></p>
                          <p>&nbsp;</p>
