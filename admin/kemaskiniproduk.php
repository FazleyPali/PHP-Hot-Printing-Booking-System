...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form2")) {
  $updateSQL = sprintf("UPDATE produk SET nama_produk=%s, harga=%s, warna=%s, saiz=%s, huraian=%s, gambar=%s WHERE kod_produk=%s",
          ...
          <div style="border:2px solid#001100">
            ...
            <tr valign="baseline">
              ...
              <td><span id="sprytextfield1">
                <input type="text" name="nama_produk" value="<?php echo htmlentities($row_rsProduk['nama_produk'], ENT_COMPAT, 'utf-8'); ?>" size="32">
                <span class="textfieldRequiredMsg">Sila penuhkan.</span></span></td>
            </tr>
            <tr valign="baseline">
              <td nowrap align="right">Harga:</td>
              <td><span id="sprytextfield2">
              <input type="text" name="harga" value="<?php echo htmlentities($row_rsProduk['harga'], ENT_COMPAT, 'utf-8'); ?>" size="32">
            ...
            <tr valign="baseline">
              ...
              <td><input type="text" name="warna" value="<?php echo htmlentities($row_rsProduk['warna'], ENT_COMPAT, 'utf-8'); ?>" size="32"></td>
            </tr>
            <tr valign="baseline">
              <td nowrap align="right">Saiz:</td>
              <td><input type="text" name="saiz" value="<?php echo htmlentities($row_rsProduk['saiz'], ENT_COMPAT, 'utf-8'); ?>" size="32"></td>
            </tr>
            <tr valign="baseline">
              <td nowrap align="right">Huraian:</td>
              <td><textarea name="huraian" cols="32" rows="5"><?php echo htmlentities($row_rsProduk['huraian'], ENT_COMPAT, 'utf-8'); ?></textarea></td>
            </tr>
            <tr valign="baseline">
              <td nowrap align="right">Gambar:</td>
              <td><input type="text" name="gambar" value="<?php echo htmlentities($row_rsProduk['gambar'], ENT_COMPAT, 'utf-8'); ?>" size="32"></td>
            </tr>
            <tr valign="baseline">
