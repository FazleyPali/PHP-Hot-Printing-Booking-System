...
$totalPages_rsjumlahproduk = ceil($totalRows_rsjumlahproduk/$maxRows_rsjumlahproduk)-1;
?>
<!DOCTYPE html>
<html lang="en">
<head>
                        ...
                        <div style="background-color:#CCC">
                          ...
                          <center>
                            ...
                            <table width="600" border="1"><center>
                              <tr>
                                <td width="189" bgcolor="#999999">Kod Produk</td>
                                <td width="200" bgcolor="#999999">Nama Produk</td>
                                <td width="149" bgcolor="#999999">Harga</td>
                                <td width="130" bgcolor="#999999">Kuantiti</td>
                              </tr>
                              <?php do { ?>
                                <tr>
                                  <td bgcolor="#FFFFFF"><?php echo $row_rsjumlahproduk['kod_produk']; ?></td>
                                  <td bgcolor="#FFFFFF"><?php echo $row_rsjumlahproduk['nama_produk']; ?></td>
                                  <td bgcolor="#FFFFFF"><?php echo $row_rsjumlahproduk['harga']; ?></td>
                                  <td bgcolor="#FFFFFF"><?php echo $row_rsjumlahproduk['count(t.kod_produk)']; ?></td>
                                </tr>
