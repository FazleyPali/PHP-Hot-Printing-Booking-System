...
$totalRows_rsPelanggan = mysql_num_rows($rsPelanggan);mysql_select_db($database_SistemTempahan, $SistemTempahan);
...
<body id="page3">
<div id="apDiv3">
  <form name="form2" method="get" action="senaraipelanggan2.php">
                          ...
                          <table width="100%" align="center">
                            ...
                            <?php do { ?>
                              <tr bgcolor="#FFFFFF">
                                ...
                                <td width="30"><a href="butiranpelanggan.php?no_mykad_pelanggan=<?php echo $row_rsPelanggan['no_mykad_pelanggan']; ?>"><img src="images/Clipboard.png" alt="butiran penuh" width="29" height="30" id="sprytrigger1" align="middle"></a></td>
                                <td width="30"><a href="kemaskinipelanggan.php?no_mykad_pelanggan=<?php echo $row_rsPelanggan['no_mykad_pelanggan']; ?>"></a><a href="kemaskinipelanggan.php?no_mykad_pelanggan=<?php echo $row_rsPelanggan['no_mykad_pelanggan']; ?>"><img src="images/Edit.png" alt="update" width="29" height="30" id="sprytrigger2" align="middle"></a></td>
                                <td width="30"><a href="padampelanggan.php?no_mykad_pelanggan=<?php echo $row_rsPelanggan['no_mykad_pelanggan']; ?>" onClick="return confirm('Anda pasti untuk padam?')"> <img src="images/Bin.png" alt="delete" width="29" height="30" id="sprytrigger3" align="middle"></a></td>
                              </tr>
                           ...
                           <center>
                             <table width="157" border="1" cellspacing="1" cellpadding="1" align="center">
                               <tr>
                                 ...
                                 <td width="116"><a href="print/printsenaraipelanggan.php" target="_blank"><img src="images/Printer.png" alt="cetak" width="81" height="80" id="sprytrigger5"></a></td>
                               </tr>
                             </table>
                           </center></p>
                          <p>&nbsp;</p>
