...
if (isset($_POST['ic'])) {
  ...
  $LoginRS__query=sprintf("SELECT no_mykad_pekerja, kata_laluan, jawatan FROM pekerja WHERE no_mykad_pekerja=%s AND kata_laluan=%s",
                    ...
                    <div style="border:2apx solid#003300">
                      <div style="border:2px solid#001100">
                        <div style="background-color:#CCC">
                          <center><img src="icon/Member Card.png" width="128" height="128"></center>
                          <center>
