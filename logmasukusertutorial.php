...
if (isset($_POST['ic'])) {
  ...
  $MM_redirectLoginSuccess = "user/indexusertutorial.php";
  $MM_redirectLoginFailed = "logmasukuser.php";
                    ...
                    <div style="border:2apx solid#003300">
                      <div style="border:2px solid#001100">
                        <div style="background-color:#CCC">
                          <p align="center">
                          <center>
                           <img src="images/user_student.png" width="151" height="151" alt="admin">
