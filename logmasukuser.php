...
if (isset($_POST['ic'])) {
  ...
  $LoginRS__query=sprintf("SELECT nama, no_mykad_pelanggan, kata_laluan, jawatan FROM pelanggan WHERE no_mykad_pelanggan=%s AND kata_laluan=%s",
  GetSQLValueString($loginUsername, "text"), GetSQLValueString($password, "text"),GetSQLValueString($nama, "text")); 
  ...
  if ($LoginFoundUser){
	  $_SESSION['no_mykad_pelanggan']=$row['no_mykad_pelanggan'];
    ...
    $_SESSION['MM_PersonName'] = $loginName; 
                    ...
                    <div style="border:2apx solid#003300">
                      <div style="border:2px solid#001100">
                        <div style="background-color:#CCC">
                          <p align="center">
                          <center>
                           <img src="icon/User.png" width="128" height="128" alt="admin"><br>
...
var sprytooltip1 = new Spry.Widget.Tooltip("sprytooltip1", "#password");
</script>
</body>
</html>