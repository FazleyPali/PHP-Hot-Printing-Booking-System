...
if (isset($_POST['ic'])) {
  ...
  $MM_redirectLoginSuccess = "admin/indexadmin.php";
  $MM_redirectLoginFailed = "logmasukadmingagal.php";
  $MM_redirecttoReferrer = false;
  mysql_select_db($database_SistemTempahan, $SistemTempahan);
  	
  $LoginRS__query=sprintf("SELECT nama, no_mykad_pekerja, kata_laluan, jawatan,nama FROM pekerja WHERE no_mykad_pekerja=%s AND kata_laluan=%s",
                    ...
                    <div style="border:2apx solid#003300">
                      <div style="border:2px solid#001100">
                        <div style="background-color:#CCC">
                          <p align="center">
                          <center>
                           <img src="icon/Member Card.png" width="128" height="128" alt="admin">
                            <p>&nbsp; </p>
